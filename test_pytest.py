...
def test_string_beautification_leading_the(input=True): # Switch this to True to easily test it also for that case.
    assert beautify_string.beautify_string("The Beatles ", remove_leading_the=input) == "Beatles", "Test Leading The"
    assert beautify_string.beautify_string(" The Beatles ", remove_leading_the=input) == "Beatles", "Test Leading The"
    assert beautify_string.beautify_string("TheBeatles ", remove_leading_the=input) == "TheBeatles", "Test Leading The"
    assert beautify_string.beautify_string("The-Beatles ", remove_leading_the=input) == "The-Beatles", "Test Leading The"
    assert beautify_string.beautify_string(None, remove_leading_the=input) == None, "Test none"
    assert beautify_string.beautify_string("The", remove_leading_the=input) == "The", "Test for a band named 'The'"
...
def test_string_fill_missing_space_after_comma():
    ...
    assert beautify_string._fill_missing_space_after_comma("neu,5") == "neu, 5" # TODO Better would be if this case would return 'neu, 5'
...
def test_track_number_beautification():
    ...
    assert beautify_disc_and_track_number.beautify_track_number(track_number="01", helper_length_max=1) == "1", "Test removing existing leading zero 1"
    assert beautify_disc_and_track_number.beautify_track_number(track_number="001", helper_length_max=2) == "01", "Test removing existing leading zeros 2"
