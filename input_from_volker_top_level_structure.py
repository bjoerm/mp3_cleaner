from typing import List # For specifying types input and output. Here only lists are loaded but import typing for all object types is also fine.
...
if __name__ == '__main__':
    ...
    main(Environment(input_path='/tmp/mp3s',    ))
