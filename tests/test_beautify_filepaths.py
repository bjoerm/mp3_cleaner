...
def tags_same_values():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album 1", TPOS="1", TDRC="2000"), dict(TPE1="Artist 1", TIT2="Title 2", TALB="Album 1", TPOS="1", TDRC="2000")])


@pytest.fixture
def tags_different_values():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album 1", TDRC="2000"), dict(TPE1="Artist 2", TIT2="Title 2", TALB="Album 2", TDRC="2001")])


@pytest.fixture
def tags_partially_missing_values():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album 1", TDRC="2000"), dict(TPE1=None, TIT2="Title 2", TALB=None, TDRC=None)])


@pytest.fixture
def tags_fully_missing_values():
    return pd.Series([dict(TPE1=None, TIT2="Title 1", TALB=None, TDRC=None), dict(TPE1=None, TIT2="Title 2", TALB=None, TDRC=None)])
...
def tags_w_disc_and_w_track_number():
    return pd.Series([dict(TRCK="01", TALB="Album 1", TPOS="1"), dict(TRCK="02", TALB="Album 1", TPOS="1")])


@pytest.fixture
def tags_w_disc_and_wo_track_number():
    return pd.Series([dict(TALB="Album 1", TPOS="1"), dict(TALB="Album 1", TPOS="1")])


@pytest.fixture
def tags_wo_disc_and_w_track_number():
    return pd.Series([dict(TRCK="01", TALB="Album 1"), dict(TRCK="02", TALB="Album 1")])


@pytest.fixture
def tags_wo_disc_and_wo_track_number():
    return pd.Series([dict(TALB="Album 1"), dict(TALB="Album 1")])


@pytest.fixture
def tags_w_disc_and_partial_track_number():
    return pd.Series([dict(TRCK="01", TALB="Album 1", TPOS="1"), dict(TALB="Album 1", TPOS="1")])


@pytest.fixture
def tags_wo_disc_and_partial_track_number():
    return pd.Series([dict(TRCK="01", TALB="Album 1"), dict(TALB="Album 1")])


@pytest.fixture
def tags_partial_disc_and_w_track_number():
    return pd.Series([dict(TRCK="01", TALB="Album 1", TPOS="1"), dict(TRCK="02", TALB="Album 1")])


@pytest.fixture
def tags_partial_disc_and_wo_track_number():
    return pd.Series([dict(TALB="Album 1", TPOS="1"), dict(TALB="Album 1")])


@pytest.fixture
def tags_partial_disc_and_partial_track_number():
    return pd.Series([dict(TALB="Album 1", TPOS="1"), dict(TRCK="02", TALB="Album 1")])


@pytest.fixture
def tags_w_disc_and_same_track_number():
    return pd.Series([dict(TALB="Album 1", TRCK="01", TPOS="1"), dict(TALB="Album 1", TRCK="01", TPOS="1")])
...
def tags_same_values_score():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album 1 (Score)", TPOS="1", TDRC="2000"), dict(TPE1="Artist 1", TIT2="Title 2", TALB="Album 1 (Score)", TPOS="1", TDRC="2000")])


@pytest.fixture
def tags_same_values_soundtrack():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album 1 (Soundtrack)", TPOS="1", TDRC="2000"), dict(TPE1="Artist 1", TIT2="Title 2", TALB="Album 1 (Soundtrack)", TPOS="1", TDRC="2000")])


@pytest.fixture
def tags_capitalization():
    return pd.Series([dict(TPE1="Artist 1", TIT2="Title 1", TALB="Album's (5th Edition)", TPOS="1", TDRC="2000"), dict(TPE1="Artist 1", TIT2="Title 2", TALB="Album's (5th Edition)", TPOS="1", TDRC="2000")])
...
def test_beautify_folder(tags_same_values, tags_same_values_score, tags_same_values_soundtrack, tags_capitalization):
    ...
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=True, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=True) is None
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=False, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=True) == "[Various Artists] - Album 1 (CD1) (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=False, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=True) is None
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=False, is_each_track_with_disc_number=True, is_same_disc_number=True) == "[Artist 1] - Album 1 (CD1)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=False, is_same_disc_number=True) == "[Artist 1] - Album 1 (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=False, is_same_disc_number=True) == "[Artist 1] - Album 1 (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=False, is_same_disc_number=False) == "[Artist 1] - Album 1 (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=False, is_same_disc_number=None) == "[Artist 1] - Album 1 (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=False, is_each_track_with_disc_number=False, is_same_disc_number=None) == "[Artist 1] - Album 1"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=None, is_each_track_with_disc_number=False, is_same_disc_number=None) == "[Artist 1] - Album 1"

    # Soundtracks and scores
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values_score, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=True) == "[Album] - Album 1 (Score) (CD1) (2000)"
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values_score, has_file_without_tags=False, is_same_artist=True, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=False) == "[Album] - Album 1 (Score) (2000)"
