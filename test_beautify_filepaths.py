...
def test_beautify_folder(tags_same_values, tags_same_values_score, tags_same_values_soundtrack, tags_capitalization):
    ...
    assert FileBeautifier._beautify_folder_name(tags=tags_same_values, has_file_without_tags=False, is_same_artist=False, is_same_album_title=True, is_same_date=True, is_each_track_with_disc_number=True, is_same_disc_number=True) is None
